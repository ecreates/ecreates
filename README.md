...
Please note: State detection and webcam feed analysing is performed in user's web browser. Thus, no user images produced by user's webcam are ever transmitted over a network. Hence, no privacy issues arise from usage of the system.
